...
import { Box, Button, Dialog, DialogContent, DialogTitle, Divider, TextField, Typography, CircularProgress, Alert } from '@mui/material'
...
const LoginPage = () => {
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: 'background.default' }}>
      ...
      <AppLogo size={90} />
      <Typography variant="body2" color="text.secondary" sx={{ mt: 2, mb: 6 }}>
        {t.common.tagline}
      </Typography>
