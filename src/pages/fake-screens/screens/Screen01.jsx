// Screen 01 — Profilo completo (mariorossi, logged in, self view, tab mancanti)
...
const Screen01 = () => {
  ...
  return (
    <Box data-screen-ready={ready ? 'true' : undefined} sx={{ minHeight: '100dvh' }}>
      <FakeProfileScreen missing={missing} doubles={doubles} producerColors={producerColors} initialTab={0} isLoggedIn isSelf />
    </Box>
  )
}
