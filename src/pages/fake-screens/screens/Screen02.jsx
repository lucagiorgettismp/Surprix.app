// Screen 02 — Profilo da browser (non loggato, login wall visibile)
...
const Screen02 = () => {
  ...
  return (
    <Box data-screen-ready={ready ? 'true' : undefined} sx={{ minHeight: '100dvh' }}>
      <FakeProfileScreen missing={missing} doubles={doubles} producerColors={producerColors} initialTab={0} isLoggedIn={false} isSelf={false} />
    </Box>
  )
}
